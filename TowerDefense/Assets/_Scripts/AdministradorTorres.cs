...
public class AdministradorTorres : MonoBehaviour
{
    ...
    {
        referenciaAdminToques.EnPlataformaTocada += CrearTorre; //Nos suscribimos al evento EnPlataformaTocada
    ...
    private void ActualizarObjetivo()
    {
        ...
        Invoke("ActualizarObjetivo", 2.5f);
    }
    ...
    public void ConfigurarTorre(int torre)
    {
        ...
        {
            Debug.Log("Esa torre no está definida");
        }
    }
}
